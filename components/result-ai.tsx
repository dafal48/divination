...
function ResultAI({
  ...
  return (
    <div className="w-full flex-1 sm:max-w-md md:max-w-2xl">
      {isLoading && (
      ...
      <div
        ...
        className="overflow-auto rounded-md border p-3 shadow dark:border-0 dark:bg-secondary/90 dark:shadow-none sm:p-5"
